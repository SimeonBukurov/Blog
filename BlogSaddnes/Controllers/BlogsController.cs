...
namespace BlogSaddnes.Controllers
{
    public class BlogsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Blogs.Include(b => b.Owner);
        ...
        {
            ViewData["OwnerId"] = new SelectList(_context.Set<User>(), "Id", "UserName");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,OwnerId,Description")] Blog blog)
        {
        ...
        public async Task<IActionResult> MyBlogs()
        {
            ...
            var model = _context.Blogs.Where(o => o.OwnerId == currentUser.Id).ToList();
            return View(model);
        }
    }
}
